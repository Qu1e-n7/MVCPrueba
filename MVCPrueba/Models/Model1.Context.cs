...
namespace MVCPrueba.Models
{
    ...
    public partial class dbMVCEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<InicioXDato_Result> InicioXDato()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InicioXDato_Result>("InicioXDato");
        }
